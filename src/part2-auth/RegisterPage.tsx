    ...
    <div className="flex-grow flex">
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-8">
        <div className="w-full max-w-md bg-dark-800 rounded-2xl p-8 border border-dark-700 shadow-xl">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">Rejoignez SENEFLIX pour réserver vos billets</p>
          </div>
      ...
      <div className="hidden lg:block lg:w-1/2 relative bg-dark-900 border-l border-dark-700">
        ...
        <div className="absolute bottom-12 left-12 right-12 text-white">
          ...
          <p className="text-xl text-gray-300">Accédez à des offres exclusives, des billets en avant-première et des événements cinématographiques spéciaux.</p>
        </div>
      </div>
    </div>
  );
